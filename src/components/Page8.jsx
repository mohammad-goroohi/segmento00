                ...
                <div className='grow flex flex-col'>
                    ...
                    <div className='grow flex'>
                        <div className='grow basis-0 flex flex-col'>
                            <div className='mb-1'>
                                <Input1 title="نام و نام خوانوادگی" errorMessage="وارد کردن نام و نام خانوادگی الزامی است." />
                            </div>
                            <div className='mb-1'>
                                <Input1 title="ایمیل" errorMessage="ایمیل را وارد کنید." />
                            </div>
                            <div className='flex'>
                            ...
                            <div className='basis-24 flex'>
                                <div className='flex items-center'>
                                    <div className='ml-5'>
                                        <Button1 text='عضویت' isActive={false}/>
                                    </div>
